            ...
            <CardContent>
                ...
                <FormControl>
                    <Stack spacing={2} direction="row" sx={{marginBottom: 4}}>
                        <TextField id="gamename" InputLabelProps={{style: inputStyles}} InputProps={{style: inputStyles}} label="GameName" variant="outlined" fullWidth required onChange={e => setGameName(e.target.value)}  />
                    ...
                    <Stack spacing={2} direction="row" sx={{marginBottom: 4}}>
                        <TextField id="totaltime" InputLabelProps={{style: inputStyles}} InputProps={{style: inputStyles}} label="Total Time" type="number" variant="outlined" fullWidth required onChange={e => setTotalTime(e.target.value)}  />
                        <TextField id="timeperquestion" InputLabelProps={{style: inputStyles}} InputProps={{style: inputStyles}} label="Time Per Question" type="number" variant="outlined" fullWidth required onChange={e => setTimePerQuestion(e.target.value)}  />
                        <TextField id="date" type='date' variant="outlined" InputLabelProps={{style: inputStyles}} InputProps={{style: inputStyles}} fullWidth required onChange={e => setDate(e.target.value)}  />
                    </Stack>
                    <br />
